...
contract MapNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 tokenId = 1;
    mapping(uint256 => uint256) public blockHeight;

    mapping(uint256 => string) public tokenInfo;

    mapping(uint256 => string) public mapType;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[6] = "block height: ";
        parts[7] = toString(blockHeight[tokenId]);
        ...
        parts[15] = "description: ";
        parts[16] = '</text><text x="10" y="140" class="base">';
        parts[17] = tokenInfo[tokenId];
        parts[18] = "</text></svg>";
    ...
    function claim(uint256 _blockHeight,string memory _tokenInfo, string memory _mapType) public nonReentrant {
        _safeMint(_msgSender(), tokenId);
        blockHeight[tokenId] = _blockHeight;
        tokenInfo[tokenId] = _tokenInfo;
        mapType[tokenId] = _mapType;
        tokenId++;
    }

    constructor() ERC721("TaiShangMapGenerator", "TSMG") Ownable() {
    }
